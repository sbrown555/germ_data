...
plotly_graph(df_actual_b, df_actual_b, 'PAR', 'CO2', colors=colors, axis_labels = None, legend_labels = None, title='CO2 and PAR in High CO2 Chamber', x_range=None, y_range1=[0,1350], y_range2=[0,1350], units=units, key=None)
